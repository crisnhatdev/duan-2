        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="col-lg-12">
                        <div class="product_top_bar d-flex justify-content-between align-items-center">
                            <div class="single_product_menu">
                                <p><span><?= count($proBySearch) ?> </span> Sản Phẩm</p>
                            </div>
                ...
                <div class="row align-items-center latest_product_inner" id="catalog_page">
                    <?php
                    foreach ($limitProBySearch as $pro) {
                        ?>
                ...
                <div class="col-lg-12">
                    <div class="pageination">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center" data-kyw="<?= $_GET['value'] ?>" data-malh = '0' data-mams="0" data-mamh="0">
                                <?php
                                $pages = $crCata->calcPage($proBySearch, 3);
                                for ($i = 0; $i < $pages; $i++) {
                                    $active = ($i === 0) ? " active" : "";
